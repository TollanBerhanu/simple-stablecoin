    ...
    return(
        <section className="py-8 px-4 m-6">
            ...
            <form className="mt-8 space-y-6" action="#">
                ...
                <button type="submit" className="w-1/4 px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> { name } </button>
