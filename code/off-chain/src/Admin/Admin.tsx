...
import UpdateOracle from "./UpdateOracle/UpdateOracle";
import DeployScripts from "./DeployScripts/DeployScripts";
import ConnectWallet from "../Components/ConnectWallet/ConnectWallet";

const Admin = () => {

    const [oracleDeployed, setOracleDeployed] = useState<boolean>(false)
    ...
    const actions = [
        ...
        {
            name: oracleDeployed ? 'Update Oracle' : 'Deploy Oracle',
            route: 'oracle',
            icon: <svg className="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
            ...
            <div className="flex">
                <div className="flex-1">
                    <Routes>
                        ...
                        <Route path="/oracle" element={ <UpdateOracle oracleDeployed={ oracleDeployed } setOracleDeployed={ setOracleDeployed } /> } />
                        <Route path="/scripts" element={ <DeployScripts /> } />
                        
                        <Route path="*" element={ <Navigate to="/admin/oracle" /> } />
