        ...
        <section className="py-8 px-4 m-6">
            ...
            <form className="mt-8 space-y-6" action="#">
                ...
                {/* <div className="inline-flex justify-center"> */}
                    <button type="submit" className="w-2/5 px-5 py-2 mx-5 text-base font-medium text-center text-white rounded-lg bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 text-lg"> Deploy / Update Oracle </button>
