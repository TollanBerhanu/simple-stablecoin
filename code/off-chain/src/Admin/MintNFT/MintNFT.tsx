...
const MintNFT = () => {
    ...
    return (
        ...
        <section className="py-8 px-4 m-6">
            ...
            <button type="button" className="w-1/4 px-5 py-3 font-medium text-center rounded-lg inline-flex items-c text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 text-sm px-5 py-2.5 mr-2 mb-2">
            ...
            <button type="submit" className="w-1/4 px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> Mint .. </button>
